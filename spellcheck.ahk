; https://the-automator.com   - Below is borrowed from the AutoHotkey forum with some minor tweaks
;~  https://the-automator.com/download/Spell_Check.ahk
...
;------------------------------------------------------------------------------
; Fix for -ign instead of -ing. Words to exclude: (could probably do this by return without rewrite)
